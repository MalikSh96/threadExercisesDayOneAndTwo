...
//    }).start();
    /*
    Code above is one solution, remove the extends in Ball.java for the code above^    
    */

    ball.start(); //second solution, needs the extends in Ball.java
    balls.add(ball);
    System.out.println("Added ball " + balls.size());
